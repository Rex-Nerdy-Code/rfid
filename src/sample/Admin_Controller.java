...
public class Admin_Controller implements Initializable {
    ...
    @FXML
    private Label Fiiname_Obj, Siiname_Obj, Matric_obj, faculty_Obj, mat_Onj, dept_obj, otherName_obj,level_obj, session_obj, phone_obj, email_obj, address_obj;
    ...
    public void Search()  {
        ...
        try {
            ...
            String query = "SELECT * FROM subdb WHERE matric_No = '" + Matric_No + "'";
                    ...
                    try {
                        while (rs.next()) {
                            ...
                            try {
                                ...
                                loader.setLocation(Controller.class.getResource("full_profile.fxml"));
                                ...
                                level_obj.setText(rs.getString("level"));
                                session_obj.setText(rs.getString("session"));
                                phone_obj.setText(rs.getString("phone_no"));
                                email_obj.setText(rs.getString("email"));
                                address_obj.setText(rs.getString("address"));
...
//            conn.close();
    ...
    public void AddStaff(){
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Controller.class.getResource("AddStaff.fxml"));
            System.out.println("collected ui successfully");
            mother_pane.setCenter(loader.load());
